...
RSpec.describe 'Advanced Nested Collections' do
  ...
  it 'test 7' do
    ...
    # all restaurants
    employee_names = []
    stores.each do |store_name,store_details|
      employee_names.push(store_details[:employees])
    end
  ...
  it 'test 9' do
    ...
    full_menu_price = 0
    # stores.each do |k,v|
    #   v[:dishes].each do |price|
    #     full_menu_price = full_menu_price + price[:price]
    #   end
    # end
    stores[:olive_garden][:dishes].each do |dish|
  ...
  it 'test 11' do
    ...
    full_menu = {}
    stores.each do |k,v|
      v[:dishes].each do |dname|
        full_menu[dname[:name]] = dname
      end
    end
    expected = {
      "Risotto" => {
